...
export interface IBalancerHelperInterface extends utils.Interface {
  functions: {
...
export interface IBalancerHelper extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IBalancerHelperInterface;
