...
export declare namespace IQuoter {
...
export interface IQuoterInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [IQuoter.QuoteExactInputSingleParamsStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [IQuoter.QuoteExactOutputSingleParamsStruct]
  ): string;
...
export interface IQuoter extends BaseContract {
  ...
  functions: {
    ...
    quoteExactInputSingle(
      params: IQuoter.QuoteExactInputSingleParamsStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
