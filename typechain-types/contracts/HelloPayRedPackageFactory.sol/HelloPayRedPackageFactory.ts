...
export interface HelloPayRedPackageFactoryInterface extends utils.Interface {
  ...
  events: {
    ...
    "NewRedPackage(uint256,uint8,address,uint256,uint256,uint256,address,string,string)": EventFragment;
...
export interface HelloPayRedPackageFactory extends BaseContract {
  ...
  filters: {
    ...
    "NewRedPackage(uint256,uint8,address,uint256,uint256,uint256,address,string,string)"(
      index?: null,
      _redPackgeType?: null,
      _token?: null,
      _totalAmount?: null,
