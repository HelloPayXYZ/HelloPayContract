...
export interface MockStrategyInterface extends utils.Interface {
  functions: {
    "addLeverage(uint256,uint256)": FunctionFragment;
    ...
    "createPosition(uint256,uint256,uint256)": FunctionFragment;
    "deposit(uint256,uint256)": FunctionFragment;
    "depositAndAddLeverage(uint256,uint256,uint256)": FunctionFragment;
    "depositAndRemoveLeverage(uint256,uint256,uint256)": FunctionFragment;
    ...
    "removeLeverage(uint256,uint256)": FunctionFragment;
    "repay(uint256,uint256)": FunctionFragment;
    "setBorrowToken(address)": FunctionFragment;
    "setEarnToken(address)": FunctionFragment;
    "withdraw(uint256,uint256)": FunctionFragment;
    "withdrawAndAddLeverage(uint256,uint256,uint256)": FunctionFragment;
    "withdrawAndRemoveLeverage(uint256,uint256,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "setBorrowToken",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "setEarnToken",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface MockStrategy extends BaseContract {
  ...
  functions: {
    addLeverage(
      ...
      lastPositionNetValue: PromiseOrValue<BigNumberish>,
    ...
    setBorrowToken(
      _borrowToken: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    setEarnToken(
      _earnToken: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
