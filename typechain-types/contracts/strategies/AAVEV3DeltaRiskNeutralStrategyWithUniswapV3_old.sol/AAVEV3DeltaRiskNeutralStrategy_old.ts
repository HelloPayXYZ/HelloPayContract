...
export interface AAVEV3DeltaRiskNeutralStrategy_oldInterface
...
export interface AAVEV3DeltaRiskNeutralStrategy_old extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AAVEV3DeltaRiskNeutralStrategy_oldInterface;
