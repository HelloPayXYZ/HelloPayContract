...
} from "../../../contracts/mock/IPoolConfigurator";
...
export class IPoolConfigurator__factory {
  ...
  static createInterface(): IPoolConfiguratorInterface {
    return new utils.Interface(_abi) as IPoolConfiguratorInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IPoolConfigurator {
    return new Contract(address, _abi, signerOrProvider) as IPoolConfigurator;
  }
}
