...
} from "../../../../contracts/interfaces/lybra/Iconfigurator";
...
export class Iconfigurator__factory {
  ...
  static createInterface(): IconfiguratorInterface {
    return new utils.Interface(_abi) as IconfiguratorInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Iconfigurator {
    return new Contract(address, _abi, signerOrProvider) as Iconfigurator;
  }
}
